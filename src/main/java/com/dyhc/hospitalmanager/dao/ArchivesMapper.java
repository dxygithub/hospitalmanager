...
public interface ArchivesMapper {
     ...
     * @return
     */
    Archives addarchives(@Param("testnumber") String testnumber);
     ...
     * @return
     */
    Integer updateArchives(@Param("testnumber") String testnumber);
     ...
     * @return
     */
    Integer addArchives(@Param("archivesId") String archivesId,@Param("testNumber") String testNumber);

    /**
     * 查询所有档案
     * @return
     */
    List<Archives>  getArchivesList();
}
